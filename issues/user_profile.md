...
*   **Router**: `app/api/v1/endpoints/users.py` [NEW] — all three routes registered under an `APIRouter(prefix="/users", tags=["users"])`.
*   **Schemas** in `app/schemas/user.py`:
