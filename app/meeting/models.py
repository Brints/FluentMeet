...
class Room(Base):
    ...
    host_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("users.id"), index=True, nullable=False)
...
class Participant(Base):
    ...
    guest_session_id: Mapped[uuid.UUID | None] = mapped_column(index=True, nullable=True)
    ...
    __table_args__ = (
        ...
        UniqueConstraint("room_id", "guest_session_id", name="uq_participant_room_guest"),
    )
